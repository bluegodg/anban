...
> 现场短版先看同目录的 `方案C现场部署作战卡.md`；当前执行稿见 `方案C当前执行说明.md`；仓库边界和可插拔验收的决策记录见 `../decisions/2026-06-16-scheme-c-repo-boundary-and-deployment.md`；长版细节见 `方案C仓库边界与部署总纲.md`、`方案C部署与联调指南.md`、`设备到手方案C首日执行单.md`。
