...
> 当前执行稿见同目录的 `方案C当前执行说明.md`；长版细节见 `方案C仓库边界与部署总纲.md`、`方案C部署与联调指南.md`、`设备到手方案C首日执行单.md`。
...
4. `docs/deployment/方案C仓库边界与部署总纲.md`：完整部署总纲。
5. `docs/deployment/方案C部署与联调指南.md`：长版联调命令和 Gate。
6. `docs/deployment/设备到手方案C首日执行单.md`：现场短清单。
